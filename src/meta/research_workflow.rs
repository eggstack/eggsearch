    ...
    if total_subqueries > max {
        ...
        if remaining > max {
            if let Some(last) = dims.last_mut() {
                ...
                last.subqueries.truncate(last.subqueries.len().saturating_sub(excess));
            }
        }
    }
...
fn architecture_decision_dimensions(query: &str) -> Vec<ResearchDimension> {
    vec![
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::PrimarySources, ResearchSourceType::OfficialDocs, ResearchSourceType::Specifications],
            subqueries: vec![
        ...
        ResearchDimension {
            ...
            subqueries: vec![
                format!("{query} reference implementation github source code"),
            ],
        },
        ResearchDimension {
            ...
            subqueries: vec![
                format!("{query} design discussion RFC proposal architecture"),
            ],
        },
        ResearchDimension {
            ...
            subqueries: vec![
                format!("{query} benchmark performance latency throughput"),
            ],
        },
        ResearchDimension {
            ...
            subqueries: vec![
                format!("{query} security considerations threat model vulnerability"),
            ],
        },
        ResearchDimension {
            ...
            subqueries: vec![
                format!("{query} migration guide adoption breaking changes"),
            ],
        },
        ResearchDimension {
            ...
            subqueries: vec![
                format!("{query} drawbacks limitations tradeoffs alternatives"),
            ],
        },
    ]
}
...
fn api_evaluation_dimensions(query: &str) -> Vec<ResearchDimension> {
    vec![
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::OfficialDocs, ResearchSourceType::Specifications],
            subqueries: vec![
                format!("{query} official API documentation reference"),
            ],
        },
        ResearchDimension {
            ...
            subqueries: vec![
                format!("{query} tutorial example getting started guide"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::ReferenceImplementations],
            subqueries: vec![
                format!("{query} source code implementation github"),
            ],
        },
        ResearchDimension {
            ...
            subqueries: vec![
                format!("{query} issues bugs known problems pitfalls"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::ReleaseNotes],
            subqueries: vec![
                format!("{query} release notes changelog version history"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::SecurityConsiderations],
            subqueries: vec![
                format!("{query} security compatibility deprecation advisory"),
            ],
        },
    ]
}
...
fn library_comparison_dimensions(query: &str, targets: &[String]) -> Vec<ResearchDimension> {
    let mut dims = vec![
        ...
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::Benchmarks],
            subqueries: vec![
                format!("{query} benchmark performance comparison"),
            ],
        },
        ResearchDimension {
            name: "Maintenance & Release Cadence".to_string(),
            purpose: "Project health, release frequency, and maintenance status".to_string(),
            source_types: vec![ResearchSourceType::ReleaseNotes, ResearchSourceType::IssueThreads],
            subqueries: vec![
        ...
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::SecurityConsiderations],
            subqueries: vec![
                format!("{query} security advisory vulnerability"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::ReleaseNotes],
            subqueries: vec![
                format!("{query} migration interop compatibility"),
            ],
        },
    ];
...
fn migration_planning_dimensions(query: &str) -> Vec<ResearchDimension> {
    vec![
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::ReleaseNotes],
            subqueries: vec![
                format!("{query} migration guide upgrade path"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::ReleaseNotes],
            subqueries: vec![
                format!("{query} changelog breaking changes deprecation"),
            ],
        },
        ResearchDimension {
            name: "Breaking-Change Issues".to_string(),
            purpose: "Issue threads discussing breaking changes and migration pain points".to_string(),
            source_types: vec![ResearchSourceType::IssueThreads],
            subqueries: vec![
                format!("{query} breaking change issue migration problem"),
            ],
        },
        ResearchDimension {
            name: "Before/After Examples".to_string(),
            purpose: "Code examples showing before and after migration".to_string(),
            source_types: vec![ResearchSourceType::ReferenceImplementations, ResearchSourceType::CommunityDiscussion],
            subqueries: vec![
                format!("{query} migration example before after code"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::SecurityConsiderations],
            subqueries: vec![
                format!("{query} security changes update advisory"),
            ],
        },
    ]
}
...
fn security_review_dimensions(query: &str) -> Vec<ResearchDimension> {
    vec![
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::SecurityConsiderations],
            subqueries: vec![
                format!("{query} security advisory CVE vulnerability"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::SecurityConsiderations],
            subqueries: vec![
                format!("{query} threat model attack surface risk"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::OfficialDocs],
            subqueries: vec![
                format!("{query} security hardening configuration best practices"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::IssueThreads],
            subqueries: vec![
                format!("{query} security issue vulnerability report"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::CommunityDiscussion],
            subqueries: vec![
                format!("{query} security analysis community discussion"),
            ],
        },
    ]
}
...
fn performance_investigation_dimensions(query: &str) -> Vec<ResearchDimension> {
    vec![
        ...
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::OfficialDocs, ResearchSourceType::CommunityDiscussion],
            subqueries: vec![
                format!("{query} profiling optimization tuning guide"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::IssueThreads],
            subqueries: vec![
                format!("{query} performance issue regression slow"),
            ],
        },
        ResearchDimension {
            name: "Comparative Analysis".to_string(),
            purpose: "Comparative performance analysis across alternatives".to_string(),
            source_types: vec![ResearchSourceType::Benchmarks, ResearchSourceType::CommunityDiscussion],
            subqueries: vec![
                format!("{query} performance comparison alternative"),
            ],
        },
    ]
}
...
fn ecosystem_survey_dimensions(query: &str) -> Vec<ResearchDimension> {
    vec![
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::OfficialDocs],
            subqueries: vec![
                format!("{query} ecosystem overview landscape"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::OfficialDocs],
            subqueries: vec![
                format!("{query} popular library recommended"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::CommunityDiscussion],
            subqueries: vec![
                format!("{query} community opinion experience comparison"),
            ],
        },
        ResearchDimension {
            name: "Recent Developments".to_string(),
            purpose: "Recent news, releases, and ecosystem developments".to_string(),
            source_types: vec![ResearchSourceType::RecentNews, ResearchSourceType::ReleaseNotes],
            subqueries: vec![
                format!("{query} recent news update announcement"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::SecurityConsiderations],
            subqueries: vec![
                format!("{query} security advisory ecosystem"),
            ],
        },
    ]
}
...
fn general_dimensions(query: &str) -> Vec<ResearchDimension> {
    vec![
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::PrimarySources, ResearchSourceType::OfficialDocs],
            subqueries: vec![
                format!("{query} official documentation reference"),
            ],
        },
        ResearchDimension {
        ...
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::DesignDiscussions],
            subqueries: vec![
                format!("{query} design discussion RFC proposal"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::SecurityConsiderations],
            subqueries: vec![
                format!("{query} security considerations vulnerability"),
            ],
        },
        ResearchDimension {
            ...
            source_types: vec![ResearchSourceType::Counterpoints],
            subqueries: vec![
                format!("{query} drawbacks limitations tradeoffs"),
            ],
        },
    ]
}
...
pub fn detect_gaps(
        ...
        )
    {
        gaps.push(ResearchGap {
            ...
            message: "No benchmark or performance data found. Performance claims may be unverifiable.".to_string(),
            suggested_query: None,
        });
    }

    if coverage.security_sources_found == 0
        && matches!(workflow, ResearchWorkflow::SecurityReview)
    {
        gaps.push(ResearchGap {
        ...
        && coverage.primary_sources_found == 0
    {
        gaps.push(ResearchGap {
            ...
            message: "No migration documentation found. Breaking changes may need manual investigation.".to_string(),
            suggested_query: None,
        });
    }
    ...
    for mut group in groups {
        ...
        if group.results.len() < original_count {
            warnings.push(format!(
                ...
                group.label, original_count, group.results.len()
            ));
...
pub fn build_workflow_context(
    ...
    let warnings: Vec<String> = gaps
        .iter()
        .map(|g| format!("{}_gap: {}", serde_json::to_string(&g.kind).unwrap_or_default(), g.message))
        .collect();
...
mod tests {
    ...
    fn make_group(kind: ResearchResultGroupKind, count: usize) -> ResearchResultGroup {
        let results: Vec<SourceCard> = (0..count)
            .map(|i| make_card(SourceKind::OfficialDocs, &format!("https://example.com/{i}")))
            .collect();
        ResearchResultGroup {
            kind,
            label: format!("{kind:?}"),
    ...
    fn gap_no_primary_sources_for_architecture_decision() {
        ...
        assert!(gaps.iter().any(|g| g.kind == ResearchGapKind::NoPrimarySources));
    }
    ...
    fn gap_no_counterpoints_when_requested() {
        ...
        assert!(gaps.iter().any(|g| g.kind == ResearchGapKind::NoCounterpoints));
    }
    ...
    fn gap_no_security_for_security_review() {
        ...
        assert!(gaps.iter().any(|g| g.kind == ResearchGapKind::NoSecurityDiscussion));
    }
    ...
    fn gap_provider_limited_when_single_provider() {
        ...
        assert!(gaps.iter().any(|g| g.kind == ResearchGapKind::ProviderCoverageLimited));
    }
    ...
    fn build_interpreted_question_variants() {
        ...
        assert!(
            build_interpreted_question(&req, ResearchWorkflow::LibraryComparison).contains("a vs b")
        );
        assert!(
        ...
        assert!(
            build_interpreted_question(&req, ResearchWorkflow::SecurityReview).contains("Security review")
        );
    }
