...
|---|---|---|---|
| Provider capability realization and Brave completion | planned | none | `phase-1-provider-request-contract-and-brave-realization.md` |
| Extractive evidence and fetch/cache controls | planned | phase 1 | `phase-2-extractive-evidence-and-fetch-control.md` |
| Firecrawl Developer Index | planned | phases 1-2 | `phase-3-firecrawl-developer-index.md` |
