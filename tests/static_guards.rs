...
fn orchestration_module_size_ratchet() {
    let ceilings: &[(&str, usize, usize)] = &[
        ...
        ("src/meta/dependency_parse/yarn.rs", 400, 81_920),
        ("src/meta/dependency_parse/yarn_berry.rs", 400, 81_920),
        ("src/meta/dependency_parse/pnpm.rs", 400, 81_920),
        ("src/meta/dependency_parse/pnpm_v9.rs", 400, 81_920),
        ("src/meta/dependency_parse/go.rs", 400, 81_920),
        ("src/meta/dependency_parse/python.rs", 400, 81_920),
        ("src/meta/dependency_parse/python_locks.rs", 400, 81_920),
        ...
        ("src/meta/dependency_parse/gradle.rs", 400, 81_920),
